        ...
        <div>
            <form method="get" action="creationClient">
                <fieldset>
                    ...
                    <input type="text" id="num_telClient" name="num_telClient" value="" size="20" maxlength="20" />
                    <br />
                    
                    <label for="emailClient">Adresse email</label>
                    <input type="email" id="mailClient" name="mailClient" value="" size="20" maxlength="60" />
                    <br />
                </fieldset>
